...
const InventoryManagementUpdateItem = (children) => {
    ...
    async function getInventoryItems() {
        ...
        try {
        const option = {
            url: `${baseUrl}farms/${children.farmId}/InventoryItems/${children.itemId}`,
            method: "GET",
            headers: {
        ...
        console.log("setInventoryItems",data);
        // if(data){
...
export default InventoryManagementUpdateItem;
