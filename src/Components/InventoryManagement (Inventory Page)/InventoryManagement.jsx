...
const InventoryManagement = (children) => {
  ...
  async function sendNewInventory(values) {
    ...
    if (!token) {
      console.error(
        "No token available or invalid farm data for sendNewInventory"
      );
      return;
    }
    console.log("inventory", children.farms[indexFarm].farmId);
            ...
            <div className="grid grid-cols-2 gap-x-[40px] ">
              ...
              <div className="">
                ...
                <MenuElement
                  ...
                  setIndex={(index) => {
                    setIndexCategory(index); // ✅ update your UI
                    formik.setFieldValue("category", index); // ✅ update formik
                  }}
                  index={indexCategory}
