...
const OPTLogin = () => {
  ...
  return (
    <section
      className="h-[100vh] flex justify-center items-center bg-black bg-opacity-70  font-manrope backdrop-blur-md "
      onClick={(e) => {
    ...
    >
      <div className=" w-[540px] h-[530px] border-2 rounded-2xl bg-white flex  flex-col items-center">
        ...
        <h1 className="text-[25px] text-mainColor capitalize font-medium my-5">
          OTP Verification
        </h1>
        <p className="w-[350px] text-[16px] text-center text-[#333333] ">
        ...
        <form action="" className="w-[75%] my-8 flex flex-col items-center">
          ...
          <button className="btn w-[90%] py-5 bg-mainColor text-white hover:bg-transparent hover:border-mainColor border-2 hover:text-mainColor font-medium mt-20">
            Verify
          </button>
          <p className="my-3 text-[#333333] text-[15px]">
            Didn’t received code? <span className="text-mainColor">Resend</span>
          </p>
        </form>
      </div>
    </section>
