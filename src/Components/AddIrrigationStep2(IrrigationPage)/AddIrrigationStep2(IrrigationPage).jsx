  ...
  return (
    ...
    >
      ...
      >
        ...
        <form
          action=""
          className="w-[100%] mt-[30px] flex flex-col justify-between  text-[20px]  flex-grow"
          onSubmit={formik.handleSubmit}
        >
          <div className="flex flex-col gap-3 my-5">
            <div className="">
              <label htmlFor="" className="ms-1">
                Irrigation Unite name
              </label>
              <input
                type="text"
                placeholder="Enter Irrigation Unite name "
              ...
              <div className="flex justify-center items-center gap-3">
                <input
                  ...
                  value={
                    ...
                    (formik.values.serialNumber = result)
                  }
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                />
