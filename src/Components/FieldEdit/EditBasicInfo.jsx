...
const EditBasicInfo = (children) => {
    ...
    let [index,setIndex]=useState(children.data.cropType);
    let [name,setName]=useState(children.data.name)
    let [area,setArea]=useState(children.data.area)
    ...
    useEffect(()=>{
        ...
        FieldName:children.data.name,
        FieldSize:children.data.area,
        CropType:children.data.cropType,
        IrrigationUnit:null,
        SensorUnit:null,
        })
        getCrops()},[])
                ...
                <form action="" className="w-[85%] my-5 flex flex-col justify-between  text-[17px]">
                    <div className="flex flex-col gap-3 my-5">
                        <div className="">
                            ...
                            <input type="text" placeholder='Enter Field Name  (At least three letters)' value={name} className='formControl mx-0 rounded-xl texvt-[15px] py-5 w-[100%] border-[#0d121c21] ' onChange={(e)=>{
                        ...
                        <div className="">
                            ...
                            <input type="number" placeholder='Enter Field Size' value={area} className='formControl mx-0 rounded-xl text-[15px] py-5 w-[100%] border-[#0d121c21] 'onChange={(e)=>{
