...
const AutomationRuleStep2IrrigationPage = (children) => {
  ...
  useEffect(() => {
    if (typeId === 1) {
      formik.values.activeDays = sumDaysValue();
    }
  }, [Days]);
  useEffect(() => {
      ...
      >
        ...
        >
              ...
              <div className="">
                ...
                <div className="">
                  ...
                  <div className="my-[10px] flex justify-between px-[15px] text-[18px] font-semibold">
                    <div
                      className="w-[40px] h-[40px] rounded-full bg-[#c2c2c23f] flex justify-center items-center  relative cursor-pointer "
                      onClick={(e) => {
                        if (Days.Mon == 0) {
                    ...
                    >
                      <Check
                        size={17}
                        className=" text-mainColor absolute -top-2  -right-2 hidden"
                      />
                      M
                    </div>
                    <div
                      className="w-[40px] h-[40px] rounded-full bg-mainColor flex justify-center items-center text-white relative cursor-pointer "
                      onClick={(e) => {
                        if (Days.Tue == 0) {
          ...
          <div className="flex justify-end items-center space-x-[16px] mt-[20px]">
            <button
              type="button"
              className="py-[8px] px-[40px] border-[1px] border-[#616161] rounded-[12px]  text-[16px] text-[#333333] hover:bg-mainColor hover:text-[#FFFFFF] hover:border-mainColor transition-all duration-300 font-medium"
              onClick={() => {
