...
const ScheduleMaintenanceSD = () => {
    ...
    return (
        <section className='h-[100vh]  flex justify-center items-center bg-black bg-opacity-70  font-manrope  absolute z-50 w-[100%]' onClick={(e)=>{if(e.target==e.currentTarget){setSchedule(null)}}}>
            <div className="w-[700px] px-[40px] h-[810px]   border-2 rounded-2xl bg-white p-[20px] text-[#0D121C] font-manrope">
                ...
                <div className=" mt-[16px] space-y-[15px] mb-[45px]">
                    <h1 className="text-[24px]  font-semibold capitalize">Schedule Maintenance for Sensor Unit A1</h1>
                    <p className="text-[19px] text-[#616161]  font-medium ">Schedule upcoming maintenance for this device.</p>
                </div>
                <div className="grid grid-cols-2 gap-x-[24px] mb-[20px]">
                    ...
                    <button type='button' className="py-[12px] px-[40px]  border-[1px] border-mainColor rounded-[12px] text-mainColor  text-[18px]  hover:bg-mainColor hover:text-[#FFFFFF] hover:border-mainColor transition-all duration-300 font-semibold" onClick={()=>{setSchedule("Log Completed")}}>
                        <div className="flex justify-center items-center space-x-[11px]">
                            <CircleCheckBig />
                ...
                <form action="" className='space-y-[10px]'>
                    <div className=" ">
                        <label htmlFor="" className='text-[20px]  font-semibold '>Start Date</label>
                    ...
                    <div className=" ">
                        <label htmlFor="" className='text-[20px]  font-semibold '>Expected Finish Date</label>
                        <input type="date" placeholder='05/05/2025' className='formControl text-[18px]  font-light placeholder:text-[#0D121C]   mx-0 h-[50px] rounded-[15px] w-full' />
                    </div>
                    <div className=" ">
                        <label htmlFor="" className='text-[20px]  font-semibold '>Maintenance Plan</label>
                        <textarea name="" id="" placeholder='Describe the planned maintenance activities...' className='formControl min-h-[151px] text-[18px]   placeholder:text-[#9F9F9F]   mx-0  rounded-[15px] w-full'></textarea>
                    </div>
                </form>
