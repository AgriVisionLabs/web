        ...
        <section className='h-[100vh]  flex justify-center items-center bg-black bg-opacity-70  font-manrope  absolute z-50 w-[100%]' onClick={(e)=>{if(e.target==e.currentTarget){setSchedule(null)}}}>
            <div className="w-[600px] px-[30px] h-fit   border-2 rounded-2xl bg-white p-[10px] text-[#0D121C] font-manrope">
                ...
                <div className=" mt-[16px] space-y-[15px] mb-[25px]">
                    <h1 className="text-[22px]  font-semibold capitalize">Log Maintenance for Sensor Unit A1</h1>
                    <p className="text-[18px] text-[#616161]  font-medium ">Log maintenance that has been performed on this device.</p>
                </div>
                <div className="grid grid-cols-2 gap-x-[24px] mb-[20px]">
                    <button type='button' className="py-[12px] px-[40px]  border-[1px] border-mainColor rounded-[12px] text-mainColor  text-[16px]  hover:bg-mainColor hover:text-[#FFFFFF] hover:border-mainColor transition-all duration-300 font-semibold" onClick={()=>{setSchedule("ScheduleMaintenan")}}>
                ...
                <form action="" className='space-y-[10px]'>
                    <div className=" ">
                        <label htmlFor="" className='text-[18px]  font-semibold '>Completion Date</label>
                        <input type="date" placeholder='06/04/2025' className='formControl mt-[10px] text-[18px]  font-light placeholder:text-[#0D121C]   mx-0 h-[50px] rounded-[15px] w-full' />
                    </div>
                    <div className=" ">
                        <label htmlFor="" className='text-[18px]  font-semibold '>Maintenance Plan</label>
                        <textarea name="" id="" placeholder='Describe the maintenance that was performed...' className='formControl min-h-[131px] text-[18px]   placeholder:text-[#9F9F9F]   mx-0  rounded-[15px] w-full'></textarea>
                    </div>
                </form>
