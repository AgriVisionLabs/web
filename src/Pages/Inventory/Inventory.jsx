...
const Inventory = () => {
  let { baseUrl,getPart } = useContext(AllContext);
  let { token } = useContext(userContext);
  let [setPart] = useState("environmental");
  let [farms, setFarms] = useState([]);
  let [farmNames, setFarmNames] = useState([]);
  let [indexFarm, setIndexFarm] = useState(0);
  let [addNewInventory,setAddNewInventory]=useState(false)
    ...
    <section className="text-[#0D121C] transition-all duration-500">
      <div className="flex  gap-y-[20px] flex-col xl:flex-row justify-between items-center mb-[40px]">
        ...
        <div className="flex space-y-4 xl:space-y-0 xl:space-x-4 flex-col xl:flex-row items-center  xl:items-start space-[12px] text-[15px] font-medium">
          ...
          <button className="border-[1px] border-mainColor bg-mainColor hover:bg-transparent hover:text-mainColor  rounded-[8px] px-[15px] py-[9px] text-white hover " onClick={()=>{setAddNewInventory(true)}}>
      ...
      <div className="mt-[20px]">
        <div className="rounded-[15px] w-full grid grid-cols-7  overflow-x-auto border border-[#0d121c37]">
            ...
            <div className="min-w-[700px] lg:min-w-[900px] xl:min-w-[1000px] 2xl:min-w-[1237px]">
              <div className="grid grid-cols-7  space-x-6 font-medium text-[14px] text-center">
                ...
                <div className="p-[15px]  text-white">
                  <div className="flex justify-center w-full   items-start">
                    <p className=" capitalize flex justify-center  items-center px-[12px] rounded-full py-[2px] bg-[#25C462]">high</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-7 space-x-6 font-medium text-[14px] text-center">
                ...
                <div className="p-[15px] flex text-white">
                  <div className="flex justify-center w-full  items-start">
                    <p className="rounded-full flex justify-center items-center px-[12px] py-[2px] bg-[#F4731C] capitalize">medium</p>
                  </div>
                </div>
                <div className="p-[15px]">
                  <div className="rounded-full flex space-x-[5px] items-center  text-[#25C462]">
              ...
              <div className="grid grid-cols-7 space-x-6 font-medium text-[14px] text-center">
                ...
                <div className="p-[15px]  text-white ">
                  <div className="flex justify-center w-full  items-start  ">
                    <p className=" capitalize rounded-full flex justify-center items-center px-[12px] py-[2px] bg-[#F04444]">low</p>
                  </div>
                </div>
                <div className="p-[15px]">
      ...
      {addNewInventory?<div className="flex absolute inset-0 justify-center items-center">
        <InventoryManagement setAddNewInventory={setAddNewInventory} farmNames={farmNames} farms={farms}/>
      </div>:null}
    </section>
  );
};
