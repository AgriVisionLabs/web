...
const Home = () => {
  ...
  function active(e, n) {
    ...
    let elements = document.querySelectorAll(
      "main div div div.activePage1 div"
    );
    let elements2 = document.querySelectorAll(
      "main div div div.activePage2 div"
    );
    let count = -1;
    if (n == 1) {
      ...
      <section className="Home " title="Home">
        <nav className=" h-[48px] z-50  fixed order-5  right-0 left-0 flex justify-between items-center  bg-[#F7F7F7] px-2 md:px-[25px] py-[10px]  text-[21px] border-b-2 border-[#0d121c21] transition-all duration-500">
          <div className="menu&Icon flex  items-center lg:space-x-5 ">
            <i
              className="fa-solid fa-bars hover:text-mainColor w-0 overflow-hidden  lg:w-5 transition-all duration-500"
              onClick={() => {
                OpenMenuList();
              }}
            ></i>
          ...
          <div className="transition-all  duration-500">
            <div className="sidebar  w-auto  z-50 order-8 fixed top-[48px] bottom-0 flex  me-6  text-[#0D121C]  font-[400]   ">
              <div className="bg-[#F7F7F7] flex  flex-col justify-between border-[#0d121c21] border-e-2 lg:border-0 h-[100%]">
                <div
                  className="px-3 xl:ps-6 xl:pe-5 pt-12 activePage1 transition-all duration-300 space-y-[30px]"
                  onClick={(e) => {
                    active(e, 1);
                  }}
                >
                ...
                <div className="flex px-3 lg:ps-6 lg:pe-5 text-[16px]  hover:text-[#1E6930] pt-3 border-t-2 transition-all duration-300 ">
                  <div
                    className="flex pb-3 pt-2 cursor-pointer "
                    onClick={() => {
                      logOut();
                      navigate("/login");
                    }}
              ...
              <div
                className={`bg-[#F7F7F7] menuList hidden transition-[width]  overflow-hidden  lg:flex  duration-500   flex-col justify-between h-[100%]   border-[#0d121c21] lg:border-e-2`}
              >
                <div
                  className="pt-12 activePage2 pe-2 space-y-[30px] "
                  onClick={(e) => {
                    active(e, 2);
                  }}
                >
