...
const Fields = (children) => {
    ...
    return (
        <>
                {farmData?<div className="  h-full   order-7 overflow-hidden   transition-all duration-500">
                    ...
                    <div className=" absolute -bottom-[0%] text-[#585858] hover:text-[#070707] transition-all duration-150 ">
                    ...
                    {   addField==1?<div className=' fixed z-50 inset-0  '><AddNewField setFieldData={setFieldData}  setCropType={setCropType}/></div>:
                        ...
                        addField==4?<div className=' fixed z-50 inset-0  '><ReviewField FieldData={FieldData}  getFields={getFields} farmId={children.farmId} cropType={cropType}/></div>:""
                    }
        </>
    );
}
