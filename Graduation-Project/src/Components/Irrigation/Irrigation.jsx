...
const Irrigation = () => {
        let {outClick,setBasicInfo,setTeam,setAddField}=useContext(AllContext);
        return (
                    ...
                    <form action="" className="w-[75%] my-5 flex flex-col justify-between  text-[18px] flex-grow">
                        <div className="flex flex-col gap-3 my-5">
                            <div className="">
                                ...
                                <input type="text" placeholder='Enter Irrigation unit name ' className='formControl mx-0 rounded-xl text-[16px] py-5 w-[100%] border-[#0d121c21] '/>
                            </div>
