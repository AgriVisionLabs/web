...
const ForgetPassword = () => {
    let {setForgetPassword,setOtp,outClick}=useContext(AllContext);
        ...
        <>
            <section className="h-[100vh] flex justify-center items-center bg-black bg-opacity-70  font-manrope backdrop-blur-md" onClick={(e)=>{
                ...
                <form action="" className="w-[75%] my-8 flex flex-col items-center">
                    <input type="text" placeholder="Enter your Email" className="formControl"/>
                    <button className="btn w-[90%] py-5 bg-mainColor text-white hover:bg-transparent hover:border-mainColor border-2 hover:text-mainColor font-medium my-20" onClick={()=>{setOtp(true);
