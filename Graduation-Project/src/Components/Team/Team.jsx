...
const Team = (children) => {
    let {outClick,setTeam,setReview,setBasicInfo,onListItem,setOnListItem}=useContext(AllContext);
...
//             const options={
//                 url:`https://agrivision.tryasp.net/farms/${children.farmId}/Invitations/pending` ,
//                 method:"GET",
//                 headers:{
...
//         try {
//             const options={
//                 url:`https://agrivision.tryasp.net/farms/${farmId}/Invitations/${invitationId}` ,
//                 method:"DELETE",
//                 headers:{
//                     Authorization:`Bearer ${token}`,
//                 },
...
//         }
    ...
    function AddInvitations(values){
            children.teamMemberList.push({recipient:values.recipient,
                    ...
                    <div className=" flex flex-col justify-between ">
                        <form action="" className="flex items-end space-x-3  " onSubmit={formik.handleSubmit}>
                            ...
                            <div className=" h-full ">
                                ...
                                <MenuElement Items={forms} name={"manager"} width={140+"px"} Pformat={"text-[16px] font-[400]  select-none  text-[#9F9F9F]"} className={" rounded-xl border-[1px] mt-2  px-2 py-5 mb-[4px]  h-[45px] border-[#0d121c21]"}  onList={onListItem} setOnList={setOnListItem} nameChange={forms[indexBI]} setIndex={setIndexBI}  />
                    ...
                    <div className=" flex-grow  overflow-hidden  ">
                        ...
                        <div className="h-[300px] overflow-y-auto">
                            {children.farmData.invitations.map((item,index)=>{
                                    return <div key={index} className="flex justify-between items-center bg-[#1e693021] py-3 px-5 my-1 rounded-lg  " >
