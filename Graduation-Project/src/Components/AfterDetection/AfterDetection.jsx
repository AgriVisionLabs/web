...
const AfterDetection = () => {
    ...
    return (
        <div className="w-[1127px] h-[800px] py-[40px] px-[48px] rounded-[25px] font-manrope bg-[#FFFFFF]">
            ...
            <div className="flex justify-between items-center ">
                    <div className="flex items-center space-x-[11px] my-[25px] ">
                        <CircleCheckBig strokeWidth={1.5} size={23} className='text-[#25C462]'/>
                        <CircleX strokeWidth={1.5} className='text-[#E13939] hidden'/>
                        <p className="text-[19px] font-semibold capitalize">healthy</p>
                    </div>
                    <h3 className="bg-[#25C462] rounded-[15px] px-[12px] py-[4px] text-[16px] font-semibold text-[#FFFFFF] capitalize">healthy</h3>
                    <h3 className="bg-[#E13939] rounded-[15px] px-[12px] py-[4px] text-[16px] font-semibold text-[#FFFFFF] capitalize hidden">infected</h3>
            </div>
            ...
            <div className="flex flex-col items-center mt-[24px]">
                <div className="w-[1031px] h-[450px] rounded-xl overflow-hidden">
                    <img src={img1} alt="" className="w-[1031px] h-[450px] bg-contain " />
                </div>
