...
const AddIrrigationStep1IrrigationPage = (children) => {
    ...
    //         try {
    //             const options={
    //                 url:`https://agrivision.tryasp.net/farms/${children.farmfarmId}/Fields`,
    //                 method:"GET",
    //                 headers:{
        ...
        <section className='h-[100vh]  flex justify-center items-center bg-black bg-opacity-70  font-manrope  absolute z-50 w-[100%]' onClick={(e)=>{if(e.target==e.currentTarget){setControlIrrigationPage(null)}}}>
            <div className="w-[650px] h-[400px]   border-2 rounded-2xl bg-white p-[20px]">
                ...
                <div className="px-3 mt-[35px] ">
                    ...
                    <MenuElement Items={fields} nameChange={fields[children.indexIRRS1]} setIndex={children.setIndexIRRS1} onList={onListAddNewSensorStep1} width={100+"%"} name={"Check Fields"} setOnList={setOnListAddNewSensorStep1} Pformat={"text-[#616161]"}/>
                </div>
